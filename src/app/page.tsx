    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <>
          ...
          <div>
            <h3 className="text-base font-semibold text-slate-900">Líderes y referidos</h3>
            <p className="text-sm text-slate-500">Indicadores de la red de colaboradores: alcance, vinculación y atención a damnificados.</p>
          </div>
